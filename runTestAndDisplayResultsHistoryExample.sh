...
rm -rf .allure-results
python3 -m pytest -k 'not dateTimeManipulation' --alluredir .allure-results/ --browser firefox
cp -rf .allure-results/ .allure-resultsCF/
cp -rf .allure-reports/history/ .allure-results/
allure generate .allure-results -o .allure-reports --clean

rm -rf .allure-results
python3 -m pytest -k 'not dateTimeManipulation' --alluredir .allure-results/ --browser firefox --browser webkit
